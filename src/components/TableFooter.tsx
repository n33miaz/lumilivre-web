...
export function TableFooter({
  ...
  return (
    <div className="flex items-center justify-between p-2 border-t border-gray-200 dark:border-gray-700 select-none">
      ...
      <div className="flex items-center space-x-6">
        <div className="flex items-center space-x-2">
          ...
          <select
            ...
            className="p-1 rounded-md bg-gray-100 dark:bg-gray-700 text-sm select-none"
          >
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            <img src={arrowIconLeft} className="w-4 h-4" alt="Seta para a Esquerda" />
          </button>
          ...
          <button
            ...
            className="p-1 rounded-md disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-200 dark:hover:bg-gray-700"
          >
            <img src={arrowIconRight} className="w-4 h-4" alt="Seta para a Direita" />
          </button>
        </div>
      </div>
    </div>
