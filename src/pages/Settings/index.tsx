...
const SettingItem = ({
  ...
  <div className="flex items-center justify-between p-4 border-b last:border-b-0 border-gray-200 dark:border-gray-700">
    <div className="flex items-center">
      <Icon
        className={`${iconClassName} mr-4 text-lumi-primary dark:text-lumi-label select-none`}
      />
      <div>
    ...
    <>
      ...
      {isAdmin && (
        <div className="p-6">
          ...
          <div className="rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50">
            <SettingItem
              Icon={DownloadIcon}
              title="Importar Dados"
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between mb-6 shrink-0 select-none">
        ...
        <button
          ...
          className="flex items-center space-x-2 py-2 pl-4 pr-2 rounded-lg shadow-md bg-red-600 text-white hover:bg-red-700 transform hover:scale-105"
        >
